...
parser.add_argument("--key", type=str, default="", help="GoDaddy production key")
parser.add_argument("--secret", type=str, default="", help="GoDaddy production secret")
...
def main():
    ...
    if not args.ip:
        try:
            with urlopen("https://ipv4.icanhazip.com/") as f:
                resp = f.read()
